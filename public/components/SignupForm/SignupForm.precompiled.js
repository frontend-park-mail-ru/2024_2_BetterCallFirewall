...
templates['SignupForm.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"cover\" data-section=\""
    ...
    + "\r\n                "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"toLoginLink") || (depth0 != null ? lookupProperty(depth0,"toLoginLink") : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"toLoginLink","hash":{},"data":data,"loc":{"start":{"line":11,"column":16},"end":{"line":11,"column":33}}}) : helper))) != null ? stack1 : "")
    + "\r\n            </form>\r\n        </div>\r\n    </div>\r\n</div>\r\n";
},"useData":true});
})();