(function () {
	...
	templates['SignupForm.hbs'] = template({
		1: function (container, depth0, helpers, partials, data) {
			...
			return (
				'                    ' +
				((stack1 = container.lambda(depth0, depth0)) != null
					? stack1
					: '') +
				'\n'
			);
		...
		main: function (container, depth0, helpers, partials, data) {
			...
			return (
				'<div class="cover" data-section="' +
				alias2(
					alias1(
						depth0 != null
							? lookupProperty(depth0, 'section')
							: depth0,
						depth0,
					),
				) +
				...
				alias2(
					alias1(
						depth0 != null
							? lookupProperty(depth0, 'className')
							: depth0,
						depth0,
					),
				) +
