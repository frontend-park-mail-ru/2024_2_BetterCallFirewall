			...
			return (
				...
				alias2(
					alias1(
						(stack1 =
							depth0 != null
								? lookupProperty(depth0, 'search')
								: depth0) != null
							? lookupProperty(stack1, 'img')
							: stack1,
						depth0,
					),
				) +
					...
					alias1(
						(stack1 =
							depth0 != null
								? lookupProperty(depth0, 'search')
								: depth0) != null
							? lookupProperty(stack1, 'placeholder')
							: stack1,
						depth0,
					),
				) +
				...
				alias2(
					alias1(
						(stack1 =
							depth0 != null
								? lookupProperty(depth0, 'profile')
								: depth0) != null
							? lookupProperty(stack1, 'logoutImg')
							: stack1,
						depth0,
					),
				) +
