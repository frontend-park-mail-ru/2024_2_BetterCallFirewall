...
templates['LoginForm.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"cover\" data-section=\""
    ...
    + "                "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"button") || (depth0 != null ? lookupProperty(depth0,"button") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(alias3,{"name":"button","hash":{},"data":data,"loc":{"start":{"line":10,"column":16},"end":{"line":10,"column":28}}}) : helper))) != null ? stack1 : "")
    + "\r\n            </form>\r\n        </div>\r\n    </div>\r\n</div>\r\n";
},"useData":true});
})();